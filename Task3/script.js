...
function productAdd() {
    ...
    $("#productTable tbody").append(
        ...
        "Name: " + $("#name").val() + "<br>" +
        "Gender: " + genderOutput + "<br>" +
        "Email: " + $("#email").val() + "<br>" +
        "Website: " + '<u style="color:blue">' + $("#website").val() + "</u>" + "<br>" +
        "Skills: " + skillOutput +
        "</td>" +
        "<td id='newData' class='animated fadeIn'>" +
        '<a href="' + $("#imageLink").val() + '" target="_blank">' +
        '<img src="' + $("#imageLink").val() + '" alt="Photo" title="Click to open in new tab" style="width:125px;height:100px"></a>' +
        "</td>" +
        "</tr>"
    );
}
